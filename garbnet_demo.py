...
mean_filename='garbage_detection_api/garbnet_mean.binaryproto'
deploy_filename = 'garbage_detection_api/deploy_garbnet.prototxt'
caffemodel_file = 'garbage_detection_api/garbnet_fcn.caffemodel'
